...
<meta http-equiv="refresh" />
    ...
    <body>
<center>
<h1>Send Post with Registered Details</h1>
<form action="SendPost1" method="post">
<input type="hidden" name="u1" value="<%=request.getParameter("u1")%>"/>
<input type="hidden" name="u2" value="<%=request.getParameter("u2")%>" />
<input type="hidden" name="u3" value="<%=request.getParameter("u3")%>" />
<input type="hidden" name="u4" value="<%=request.getParameter("u4")%>" />

<table style="with: 50%" align="center">
<tr>
<td>Sender Name</td>
<td><%=request.getParameter("u1")%></td>
</tr>
<tr>
<td>Sender Address</td>
<td><%=request.getParameter("u2")%></td>
</tr>
<td>Sender Pincode</td>
<td><%=request.getParameter("u3")%></td>
</tr>
<tr>
<td>Sender Phonenumber</td>
<td><%=request.getParameter("u4")%></td>
</tr>
<tr>
<td>Reciever Name</td>
